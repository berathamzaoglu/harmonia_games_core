...
namespace MultiScreenshotCaptureNamespace
{
	...
	public class MultiScreenshotCapture : EditorWindow
	{
		...
		private List<Vector2> resolutions = new List<Vector2>() { new Vector2(1080, 1920), new Vector2(1284, 2778), new Vector2(1242, 2208), new Vector2(2048, 2732) }; // Not readonly to support serialization
		...
		private void OnGUI()
		{
			...
			if (GUILayout.Button("Read Documents"))
			{
				Application.OpenURL("https://docs.google.com/document/d/1WRWLBOd1j8R11LHnCwD_XI4ohoazmZqLiylfd-oxQbU/edit?usp=sharing");
			}
